...
Как вы вероятно заметили, этот код и тестовое задание были выполнены с применением ИИ. На указанную должность не претендую, так как не обладаю необходимыми навыками в сфере программирование (учился на инженера-программиста по написанию обрабатывающих программ для станков с ЧПУ)
